  ...
  template: `
    <app-layout-sidenav
      ...
      <ng-template #hOptions>
        <button [disabled]="stockState.isFetchStocks | async"
                (click)="reload()"
                mat-menu-item>
          <mat-icon>refresh</mat-icon>
          Reload
        </button>
        <button [disabled]="stockState.isImportProducts | async"
                (click)="importProducts()"
                mat-menu-item>
          <mat-icon>file_upload</mat-icon>
          Import
        </button>
        <button [disabled]="stockState.isExportToExcel | async"
      ...
      <ng-template #body>
        <app-products-table *ngIf="(deviceState.isSmallScreen | async) === false"></app-products-table>
        <app-products-list *ngIf="(deviceState.isSmallScreen | async) === true"></app-products-list>
      </ng-template>
    </app-layout-sidenav>
  `,
