  ...
  template: `
    <div class="product-table-options-container">
      <div class="product-table-options">
        <app-stock-products-table-sub-actions
          (done)="doneInSubMenu()"
        ></app-stock-products-table-sub-actions>
        <mat-paginator
          [style]="
      ...
      <mat-progress-bar
        *ngIf="stockState.isFetchStocks | async"
        mode="indeterminate"
      ></mat-progress-bar>
    </div>
          ...
          <td mat-cell *matCellDef="let element">
            ...
            >
              ...
              <mat-menu #menu>
                ...
                <button
                  mat-menu-item
                  [matTooltip]="'permanent delete stock'"
                  (click)="deleteStock(element)"
                >
                  Delete
                </button>
              </mat-menu>
...
export class ProductsTableComponent
  ...
  editStock(element: StockModel): void {
    this.router
      .navigateByUrl("/stock/products/" + element.id + "/edit")
